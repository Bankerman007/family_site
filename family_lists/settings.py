"""
Django settings for family_lists project.
...
ALLOWED_HOSTS = ['wright-family-site.just-dev.us','127.0.0.1']
...
ROOT_URLCONF = 'family_lists.urls'
...
WSGI_APPLICATION = 'family_lists.wsgi.application'
